...
<head>
    ...
    <meta name="description" content="Award winning travel agency in India offering deals on India tour packages, Mice Travelo tour operators in India approved By IATA, Holiday and honeymoon packages booking online from Delhi Travel to India with our India travel guide and customized tour packages.">
    <meta name="keywords" content="Mice Travelo, India Travel, Travel to India, India Tour, Indian holidays, India Holiday, India Tour and Travel, India Tour Agent,Travel To India Tours ,Indian tour operators, holiday packages, India travel Agents, visit in India, international tour, Honeymoon packages, cheap air ticket booking, hotels, trip to India, Kerala Tour Packages, Himachal tour Packages, Uttarakhand Tour Packages, Kashmir Tour Packages">	
	<link rel="canonical" href="http://www.micetravelo.com/" />	
	...
	<meta property="og:site_name" content="Mice Travelo"/>
	<meta property="og:url" content="www.micetravelo.com"/>
	<meta property="og:title" content="Online Travel Agency Holiday Packages"/>    
			...
			<div class="container">
				...
				<div class="width-logo sm-logo">
					<a href="" title="Travel" rel="home">					     
					    <img src="images/logo1.png" alt="Logo" width="300" height="93" class="logo_transparent_static">			
						<img src="images/logo_sticky.png" alt="Sticky logo" width="400" height="124" class="logo_sticky">
					</a>
				</div>
				<nav class="width-navigation">
					<ul class="nav navbar-nav menu-main-menu side-nav" id="mobile-demo">
						...
						<ul class="sub-menu">
								...
								<li><a href="vaishnodevi/vaishnomata.php">May</a></li>
								<li><a href="uttarakhand/uttarakhand.php">June</a></li>
								<li><a href="somnath/somnath.php">July</a></li>
								<li><a href="kashmir/kashmir.php" >August</a></li>				
								<li><a href="vaishnodevi/vaishnomata.php">September</a></li>
								<li><a href="uttarakhand/uttarakhand.php">October</a></li>
								<li><a href="kerala/kerala.php">November</a></li>
								<li><a href="kashmir/kashmir.php">December</a></li>				
						</ul>
						</li>
						...
						<ul class="sub-menu">
								...
								<li><a href="chardhamyatra/chardhamyatra.php">CharDham  Yatra</a></li>
								<li><a href="kerala/kerala.php">Kerala</a></li>
								<li><a href="#">Kashmir</a></li>
								<li><a href="hyderabad/hyderabad.php">Hyderabad</a></li>									
						    </ul>
								...
								<li class="hb-form-field">
									<div class="hb-form-field-input hb_input_field">
										<select name="tourtax[tour_phys]">
											...
											<option value="honeymoon Tour-tour">Honeymoon Tour</option>
						...
						<div class="tours-type-slider" data-dots="true" data-nav="true" data-responsive='{"0":{"items":1}, "480":{"items":2}, "768":{"items":3}, "992":{"items":4}, "1200":{"items":5}}'>
							<div class="tours_type_item">
								...
								<div class="content-item">
									<div class="item__title">Himachal</div>
								</div>
							</div>
							<div class="tours_type_item">
								<a href="uttarakhand/uttarakhand.php" class="tours-type__item__image">
									<img src="images/city/uttarakhand.jpg" alt="Uttarakhand">
								</a>
								<div class="content-item">
									<div class="item__title">Uttarakhand</div>
								</div>
							</div>
							<div class="tours_type_item">
								<a href="kashmir/kashmir.php" class="tours-type__item__image">
									<img src="images/city/kashmir.jpg" alt="Kashmir">
								</a>
								<div class="content-item">
									<div class="item__title">Kashmir</div>
								</div>
							</div>
							<div class="tours_type_item">
								<a href="#" class="tours-type__item__image">
									<img src="images/city/goa.jpg" alt="Goa<">
								</a>
								<div class="content-item">
									<div class="item__title">Goa</div>
								</div>
							</div>
							<div class="tours_type_item">
								<a href="kerala/kerala.php" class="tours-type__item__image">
									<img src="images/city/kerala.jpg" alt="Kerala">
								</a>
								<div class="content-item">
									<div class="item__title">Kerala</div>
								</div>
							</div>
							<div class="tours_type_item">
								<a href="#" class="tours-type__item__image">
									<img src="images/city/leh-ladakh.jpg" alt="Leh Ladakh">
								</a>
								<div class="content-item">
									<div class="item__title">Leh Ladakh</div>
								</div>
							</div>
						...
						<div class="tours-type-slider list_content" data-dots="true" data-nav="true" data-responsive='{"0":{"items":1}, "480":{"items":2}, "768":{"items":3}, "992":{"items":3}, "1200":{"items":3}}'>
							<div class="item-tour">
								<div class="item_border">
									<div class="item_content">
										<div class="post_images">
											<a href="kerala/4n-5d-ker.php" class="travel_tour-LoopProduct-link">
											<span class="price">
												<span class="travel_tour-Price-amount amount">INR 9,000 PP</span>
											</span>
												<img src="images/tour/kerala-tour/tour-1.jpg" alt="" title="">
											</a>
											<div class="group-icon">
											<a href="#" data-toggle="tooltip" data-placement="top" title="" class="frist" data-original-title="Hotel"><i class="flaticon-holidays"></i></a>
											<a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Private Cab"><i class="flaticon-cart-1"></i></a>
										...
										<div class="wrapper_content">
											<div class="post_title"><h4>
												<a href="kerala/4n-5d-ker.php" rel="bookmark">Kerala</a>
											</h4></div>
											<span class="post_date">4 NIGHTS 5 DAYS </span>
									...
									<div class="read_more">
										...
										<a href="kerala/4n-5d-ker.php" class="read_more_button">VIEW MORE
											<i class="fa fa-long-arrow-right"></i></a>
										<div class="clear"></div>
									</div>
								</div>
							...
							<div class="item-tour">
								<div class="item_border">
									<div class="item_content">
										<div class="post_images">
											<a href="kerala/5n-6d-ker.php" class="travel_tour-LoopProduct-link">
											<span class="price">
												<span class="travel_tour-Price-amount amount">INR 10,000 PP</span>
 											</span>
												<img src="images/tour/kerala-tour/tour-2.jpg" alt="" title="">
											</a>
											<div class="group-icon">
											<a href="#" data-toggle="tooltip" data-placement="top" title="" class="frist" data-original-title="Hotel"><i class="flaticon-holidays"></i></a>
											<a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Private Cab"><i class="flaticon-cart-1"></i></a>
										...
										<div class="wrapper_content">
											<div class="post_title"><h4>
												<a href="kerala/5n-6d-ker.php" rel="bookmark">Kerala</a>
											</h4></div>
											<span class="post_date">5 NIGHTS 6 DAYS </span>
									...
									<div class="read_more">
										...
										<a href="kerala/5n-6d-ker.php" class="read_more_button">VIEW MORE
											<i class="fa fa-long-arrow-right"></i></a>
										<div class="clear"></div>
									</div>
								</div>
							...
							<div class="item-tour">
								<div class="item_border">
									<div class="item_content">
										<div class="post_images">
											<a href="kerala/6n-7d-ker.php" class="travel_tour-LoopProduct-link">
											<span class="price">
												<span class="travel_tour-Price-amount amount">INR 13,500 PP</span>
											</span>
												<img src="images/tour/kerala-tour/tour-3.jpg" alt="" title="">
											</a>
											<div class="group-icon">
											<a href="#" data-toggle="tooltip" data-placement="top" title="" class="frist" data-original-title="Hotel"><i class="flaticon-holidays"></i></a>
											<a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Private Cab"><i class="flaticon-cart-1"></i></a>
										...
										<div class="wrapper_content">
											<div class="post_title"><h4>
												<a href="kerala/6n-7d-ker.php" rel="bookmark">Kerala</a>
											</h4></div>
									...
									<div class="read_more">
										...
										<a href="kerala/6n-7d-ker.php" class="read_more_button">VIEW MORE
											<i class="fa fa-long-arrow-right"></i></a>
										<div class="clear"></div>
									</div>
								</div>
